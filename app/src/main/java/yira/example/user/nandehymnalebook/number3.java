...
public class number3 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView songView = findViewById(R.id.number3);
        songView.setMovementMethod(new ScrollingMovementMethod());
        songView.setText(Html.fromHtml(getString(R.string.number3)));
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String title = getString(R.string.NASYAMULANGIRA);
