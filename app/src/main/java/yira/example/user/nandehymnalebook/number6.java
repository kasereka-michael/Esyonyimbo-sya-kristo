...
public class number6 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView IMWE_BABUYIRIRE = findViewById(R.id.number6);

        TextView songView = findViewById(R.id.number6);
        songView.setMovementMethod(new ScrollingMovementMethod());
        songView.setText(Html.fromHtml(getString(R.string.number6)));

        IMWE_BABUYIRIRE.setTextIsSelectable(true);
