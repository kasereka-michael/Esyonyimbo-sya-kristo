...
public class number5 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView songView = findViewById(R.id.number5);
        songView.setMovementMethod(new ScrollingMovementMethod());
        songView.setText(Html.fromHtml(getString(R.string.number5)));
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String title = getString(R.string.MUTEYA_WE_MINYISYENDAMBI);
