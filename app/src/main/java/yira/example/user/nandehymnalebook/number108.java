...
public class number108 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number108);
        ...
        TextView songView = findViewById(R.id.number108);
        songView.setMovementMethod(new ScrollingMovementMethod());
        songView.setText(Html.fromHtml(getString(R.string.number108)));
