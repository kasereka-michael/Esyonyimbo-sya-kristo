...
public class number1 extends MainActivity {
    ImageButton play;
    ImageButton pause;
    ImageButton like;
    MediaPlayer mplayer;
    String filename = "number1";
    String resource;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      actionBar.setDisplayShowHomeEnabled(true);
        ...
        TextView MUTEYA_BUHA_ENGUBI = findViewById(R.id.number1);
        MUTEYA_BUHA_ENGUBI.setTextIsSelectable(true);
        ...
        TextView songView = findViewById(R.id.number1);
       songView.setMovementMethod(new ScrollingMovementMethod());
       songView.setText(Html.fromHtml(getString(R.string.number1)));
       ...
       resource =  "raw/" + filename;
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String title = getString(R.string.MUTEYA_BUHA_ENGUBI);
               ...
               String fil =  gson.toJson(song);
                ...
                Toast.makeText(number1.this, "liked", Toast.LENGTH_LONG).show();
