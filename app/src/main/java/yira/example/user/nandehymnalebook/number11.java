...
public class number11 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number11);
        ...
        TextView  MULAMYA_NGANDIKUKWAMA = findViewById(R.id.number11);

        TextView songView = findViewById(R.id.number11);
        songView.setMovementMethod(new ScrollingMovementMethod());
        songView.setText(Html.fromHtml(getString(R.string.number11)));
        MULAMYA_NGANDIKUKWAMA.setTextIsSelectable(true);
    ...
    public boolean onSupportNavigateUp(){
        ...
        Intent backMain = new Intent(this, MainActivity.class);
        Log.i("nandehymne","finally went back");
