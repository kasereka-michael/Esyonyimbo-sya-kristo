...
public class number10 extends MainActivity {
  ...
  //code ty enable text selectable copy and paste even share
        TextView TWASYAHINDANA_ELUBULA = findViewById(R.id.number10);


        TextView songView = findViewById(R.id.number10);
        songView.setMovementMethod(new ScrollingMovementMethod());
        songView.setText(Html.fromHtml(getString(R.string.number10)));

        TWASYAHINDANA_ELUBULA.setTextIsSelectable(true);
